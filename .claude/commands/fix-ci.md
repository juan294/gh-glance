...
6. After all fixes, run the full verification suite locally (no typecheck
   or test script exists in this project -- don't invent one):
   `npm run lint 2>&1; node --check index.mjs 2>&1`
